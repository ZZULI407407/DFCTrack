...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='mambalct', choices=['mambalct'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='baseline_256_300', help='yaml configure file name')
