...
# dataset_name = 'tnl2k' # lasot_extension_subset
dataset_name = 'uav' # lasot_extension_subset


trackers.extend(trackerlist(name='dfctrack', parameter_name='baseline_384', dataset_name=dataset_name,
                            run_ids=300, display_name='dfctrack'))
